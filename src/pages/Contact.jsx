...
export default function Contact() {
    return (
        <div className="container-xl">
            <h1>Contact</h1>
            <p>I'm currently seeking employment and am open to a range of software development work. I hope the projects here and on my GitHub demonstrate knowledge and skill with a variety of languages and types of programming.    </p>
